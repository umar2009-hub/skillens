...
*   **Deployment Target:** Vercel (Frontend) & Koyeb (Backend).
...
SkillLens is fully optimized for production deployment. Please refer to the comprehensive [Deployment Guide](docs/DEPLOYMENT_GUIDE.md) for step-by-step instructions on deploying the stack to Vercel and Koyeb.
